...
|CI| |Travis| |Codecov| |Readthedocs-stable| |Readthedocs-latest|
...
.. |CI| image:: https://github.com/xflr6/graphviz/workflows/CI/badge.svg
    :target: https://github.com/xflr6/graphviz/actions?query=workflow%3ACI
    :alt: CI
